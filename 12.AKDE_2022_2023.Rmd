...
### Loading data and select foraging points
...
### Removing foraging points inside Isla Colón
...
bats_feb_idday <- bats_feb[,c(-22,-23,-29,-32,-40,-42,-43,-52)]#,-46
...
### Overlap calculation by individual day
...
```{r}
### only 202 data
idday2022 <- bats_2022_2023_c[,c(-22,-23,-29,-32,-40,-42,-43,-52)]%>%
...
```{r}
bats2023 <- bats_2022_2023_c[,c(-22,-23,-29,-32,-40,-42,-43,-52)] %>%
  filter(date>="2023-01-01")
...
write.csv(overlap_all, file="~/ownCloud/PhDLife/P.hastatus/Thesis/Paper3/data/overlap_data.csv")
