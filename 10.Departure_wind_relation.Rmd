...
#bload all departures and returns including illumination data
...
# step 1: create a sequence of predictor values for mean wind speed and illumination
...
```
### Plot departures, mean wind speed and illumination, and returns
```{r}
# read departure data frame
read.csv(file="/Users/ccalderon/ownCloud/PhDLife/P.hastatus/Thesis/Paper3/data/alldepartures.csv")

# read return data frame
read.csv(file="/Users/ccalderon/ownCloud/PhDLife/P.hastatus/Thesis/Paper3/data/allreturns.csv")
...
### Composite figure of departures and ilumination
```{r}
dep_plot/dep_ilu_ws  + 
